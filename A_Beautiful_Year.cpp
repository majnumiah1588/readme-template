...
#define OP2(a,b)                     cc<<a<<b<<nl;
#define OP3(a,b,c)                   cc<<a<<b<<c<<nl;

void solve()
{
    in(n); n++; ll k=n,a,b,c,d;
    while(1){
        a=n%10; n/=10; b=n%10; n/=10; c=n%10; n/=10; d=n;
        if(a!=b && a!=c && a!=d && b!=c && b!=d && c!=d) {OP(k); break;} else {k++; n=k;}
    }
}
int main()
{
